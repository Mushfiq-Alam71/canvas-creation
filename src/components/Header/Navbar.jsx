...
const Navbar = () => {
    ...
    const navLink = <div className="flex flex-col lg:flex-row gap-4 z-10 list-none h-full w-full">
        <li className="w-full"><NavLink to='/' className={`btn btn-outline  rounded-full text-lg  whitespace-nowrap`}>Home</NavLink></li>
        <li className="w-full"><NavLink to='/allartcrafts' className={`btn btn-outline  rounded-full text-lg whitespace-nowrap`}>All Art & Crafts</NavLink></li>
        <li className="w-full"><NavLink to='/addCraft' className={`btn btn-outline  rounded-full text-lg whitespace-nowrap`}>Add Craft Item</NavLink></li>
